...
@NamedNativeQueries({
    ...
    @NamedNativeQuery(name = "Contact.updateMsgStatusNative", query = "UPDATE Contact c SET c.status = ?1 WHERE c.contactId = ?2")
})
// Spring Data Jpa does not support dynamic sorting for native queries
