...
@CrossOrigin(origins = "*")
// we are establishing a communication between multiple servers or multiple domains with this annotation
public class ContactRestController {
  ...
  public ResponseEntity<Response> deleteMsg(ResponseEntity<Contact> requestEntity) {
  ...
  public ResponseEntity<Response> closeMsg(@RequestBody Contact contactRequest) {
    ...
    if (contact.isPresent()) {
      contact.get().setStatus(DemoSchoolConstants.CLOSE);
